    ...
    return (
        <div className='w-full h-auto px-4 py-20'>
            ...
            <div className='grid gap-6 grid-cols-[repeat(auto-fit,minmax(20rem,1fr))] w-full justify-items-center'>
                <div className='shadow-xl flex flex-col items-center justify-center w-80 h-60  p-4 gap-3 rounded-2xl border-teal-700 border-2 hover:scale-110 transition duration-300 cursor-pointer'>
                ...
                <div className='shadow-xl flex flex-col items-center justify-center w-80 h-60 text-center border-teal-700 border-2   p-4 gap-3 rounded-2xl hover:scale-110 transition duration-300  cursor-pointer'>
