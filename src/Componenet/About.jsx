    ...
    <div className={`w-full h-auto  py-16 flex flex-col items-center justify-center`}>
      ...
      <div className='w-full h-auto flex flex-col lg:flex-row items-center justify-center gap-12'>
        ...
        <motion.div initial={{ x: -50, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 0.6 }} className='w-[400px] h-[500px] flex flex-row items-center justify-between '>
          ...
          <div className={`w-[280px] h-[400px] ${light? 'bg-black/50': 'bg-white/50'} rounded-3xl overflow-hidden flex items-center justify-center`}>
        ...
        <motion.div initial={{ x: 50, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 0.6 }} className='w-full lg:w-[600px]  lg:text-start px-6'>
