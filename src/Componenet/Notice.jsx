...
const Notice = () => {
    ...
    return (
        <div className={`w-full h-8 text-white border-b-[1px] border-t-[1px] flex flex-row items-center justify-around gap-4 text-xs lg:text-base ${light? "bg-gray-600": "bg-gray-800"} text-white`}>
