...
function Footer() {
  ...
  return (
    <footer className={`flex flex-col gap-4 w-full h-auto items-center justify-center  pb-8 bg ${light? "bg-gray-800": "bg-gray-900"} text-white`}>
      ...
      <p>All rights are reserved by <a href="/" className='text-emerald-400 font-bold text-xl'>Tanvir Ahmmed</a> | {year}</p>
    </footer>
  )
}
