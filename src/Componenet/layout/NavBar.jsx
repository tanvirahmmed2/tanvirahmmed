...
function NavBar() {
    ...
    return (
        <nav className={`w-full  h-14  backdrop-blur-md flex flex-row items-center justify-between px-4 md:px-8 fixed font-sans z-50 text-base bg-white text-black shadow-sm shadow-black `}>
            ...
            <div className={`relative flex md:hidden flex-col items-center justify-center  h-14 w-28`}>
                ...
                <div className={`absolute ${!menu ? "hidden" : "flex"} flex-col w-[130px] h-auto gap-4 items-start top-14 shadow-sm shadow-indigo-400 ${light? 'bg-white text-black': 'bg-gray-800 text-white'} rounded-br-md rounded-bl-md py-4 px-4 `}>
