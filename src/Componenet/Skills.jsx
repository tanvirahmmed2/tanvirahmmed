    ...
    return (
        <div className='w-full h-auto min-h-[90vh] flex flex-col items-center justify-center gap-6 py-16'>
            ...
            <div className='w-full h-auto flex flex-col md:flex-row items-center justify-center gap-12'>
                ...
                <motion.div initial={{x:-50, opacity:0}} whileInView={{x:0, opacity:1}} transition={{duration:0.6}} className='w-[300px] md:w-[230px] h-[400px] bg-white/5 shadow-sm shadow-cyan-600 p-8 rounded-3xl flex flex-col items-center justify-between'>
                ...
                <motion.div initial={{y:-20, opacity:0}} whileInView={{y:0, opacity:1}} transition={{duration:0.6}} className='w-[300px] md:w-[230px] h-[400px] bg-white/5 shadow-sm shadow-emerald-600 p-8 rounded-3xl flex flex-col items-center justify-between'>
                ...
                <motion.div initial={{x:50, opacity:0}} whileInView={{x:0, opacity:1}} transition={{duration:0.6}} className='w-[300px] md:w-[230px] h-[400px] bg-white/5  shadow-sm shadow-indigo-600 p-8 rounded-3xl flex flex-col items-center justify-between'>
