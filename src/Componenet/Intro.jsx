        ...
        <div className='w-full h-auto min-h-screen py-16 flex flex-col items-center justify-center  text-center px-4'>
            <div className='w-3/4 h-auto flex flex-col items-center justify-center gap-4 text-center'>
                ...
                <div className='h-auto md:w-[400px] text-xs md:text-base w-[160px] group gap-2   flex flex-col md:flex-row'>
                    <div className='flex w-full  mt-2 flex-col group relative group/item1 bg-white  hover:bg-transparent transition-all duration-500 ease-out origin-left rounded-lg'>
                    ...
                    <div className='flex w-full  mt-2 flex-col group relative group/item2 bg-white  hover:bg-transparent transition-all duration-500 ease-out origin-left rounded-lg'>
