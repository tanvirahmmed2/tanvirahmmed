    ...
    <div className='w-full p-12 h-auto flex-col min-h-screen gap-6 items-center flex bg-white/5'>
      ...
      <div className=' w-full p-2 grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] justify-items-center h-auto gap-8'>
        ...
        {projectDatas.map((Data) => {
          ...
          return <div key={id} className='w-[280px] h-[400px] relative rounded-lg overflow-hidden hover:shadow-2xl cursor-pointer shadow-green-400 hover:scale-105 transition duration-500'>
