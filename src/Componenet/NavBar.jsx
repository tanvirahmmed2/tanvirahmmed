    ...
    return (
        <nav className='w-full h-12 shadow-sm flex flex-row items-center justify-between px-4 md:px-8 fixed z-50 bg-white  '>
            ...
            <div className={`relative flex md:hidden flex-col items-center justify-center h-12 w-28`}>
                ...
                <div className={`absolute ${!menu ? "hidden":"flex"} flex-col w-[130px] gap-4 items-start top-12 shadow-2xl bg-white py-4 px-4 rounded-xl`}>
                    <Link to='/services' className=' h-8 w-full pl-4 hover:pl-6 hover:scale-110 hover:text-teal-500 cursor-pointer font-semibold'>Services</Link>
                    <Link to='/projects' className='h-8 w-full pl-4 hover:pl-6 hover:scale-110 hover:text-teal-500 cursor-pointer font-semibold '>Projects</Link>
                    <Link to='/reviews' className='h-8 w-full pl-4 hover:pl-6 hover:scale-110 hover:text-teal-500 cursor-pointer font-semibold'>Reviews</Link>
                    <Link to='/contact' className='h-8 w-full pl-4 hover:pl-6 hover:scale-110 hover:text-teal-500 cursor-pointer font-semibold '>Contact</Link>
                    <a href="/Tanvir_Ahmmed_resume.pdf"  download className='h-8 w-full pl-4 hover:pl-6 hover:scale-110 hover:text-teal-500 cursor-pointer font-semibold text-red-600'>Resume</a>
                </div>
            </div>
