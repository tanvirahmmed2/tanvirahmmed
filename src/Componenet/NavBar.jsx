        ...
        <nav className='w-full h-12 flex flex-row items-center justify-between px-8 rounded-4xl relative z-50 text-white'>
            ...
            <div className={`relative flex md:hidden flex-col items-center justify-center h-12 w-28`}>
                ...
                <div className={`absolute ${menu} flex-col items-start top-14 text-black`}>
                    <Link to='/services' className='w-[100px] h-8 items-center justify-center flex hover:scale-105 hover:text-red-600 cursor-pointer font-semibold bg-white'>Services</Link>
                    <Link to='/projects' className='w-[100px] h-8 items-center justify-center flex hover:scale-105 hover:text-red-600 cursor-pointer  font-semibold bg-white'>Projects</Link>
                    <Link to='/reviews' className='w-[100px] h-8 items-center justify-center flex  hover:scale-105 hover:text-red-600 cursor-pointer  font-semibold bg-white'>Reviews</Link>
                    <Link to='/contact' className='w-[100px] h-8 items-center justify-center flex  hover:scale-105 hover:text-red-600 cursor-pointer font-semibold bg-white'>Contact Me</Link>
                    <a href="/Tanvir_Ahmmed_resume.pdf"  download className='w-[100px] h-8 items-center justify-center flex  hover:scale-105 hover:text-red-600 cursor-pointer  bg-white font-semibold '>Resume</a>
                </div>
            </div>
